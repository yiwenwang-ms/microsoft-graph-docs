...
-->
``` http
POST /user/authentication/temporaryAccessPassMethods/{temporaryAccessPassAuthenticationMethodId}/resetPassword
```
...
-->
``` http
POST https://graph.microsoft.com/beta/user/authentication/temporaryAccessPassMethods/{temporaryAccessPassAuthenticationMethodId}/resetPassword
