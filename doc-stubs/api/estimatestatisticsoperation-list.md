...
-->
``` http
GET ** Collection URI for microsoft.compliance.ediscovery.contract.estimateStatisticsOperation not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.compliance.ediscovery.contract.estimateStatisticsOperation not found
```
