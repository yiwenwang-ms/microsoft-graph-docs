...
-->
``` http
GET /identity/b2cUserFlows/{b2cIdentityUserFlowId}/userFlowIdentityProviders
```
...
-->
``` http
GET https://graph.microsoft.com/beta/identity/b2cUserFlows/{b2cIdentityUserFlowId}/userFlowIdentityProviders
```
