...
-->
``` http
POST /applications/{applicationsId}/appManagementPolicies/{appManagementPolicyId}/appliesTo/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/applications/{applicationsId}/appManagementPolicies/{appManagementPolicyId}/appliesTo/$ref
