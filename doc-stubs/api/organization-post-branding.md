...
-->
``` http
POST /organization/{organizationId}/branding
```
...
-->
``` http
POST https://graph.microsoft.com/beta/organization/{organizationId}/branding
...
{
  "@odata.type": "#Microsoft.DirectoryServices.organizationalBranding",
  "id": "d26a7c28-7c28-d26a-287c-6ad2287c6ad2",
  "backgroundColor": "String",
  "backgroundImage": "Stream",
  "backgroundImageRelativeUrl": "String",
  "bannerLogo": "Stream",
