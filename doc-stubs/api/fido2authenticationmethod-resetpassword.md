...
-->
``` http
POST /user/authentication/fido2Methods/{fido2AuthenticationMethodId}/resetPassword
```
...
-->
``` http
POST https://graph.microsoft.com/beta/user/authentication/fido2Methods/{fido2AuthenticationMethodId}/resetPassword
