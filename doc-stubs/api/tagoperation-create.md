...
Create a new [tagOperation](../resources/tagoperation.md) object.
...
-->
``` http
POST ** Collection URI for microsoft.compliance.ediscovery.contract.tagOperation not found
```
...
## Request body
In the request body, supply a JSON representation of the [tagOperation](../resources/tagoperation.md) object.

The following table shows the properties that are required when you create the [tagOperation](../resources/tagoperation.md).
...
If successful, this method returns a `201 Created` response code and a [tagOperation](../resources/tagoperation.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.compliance.ediscovery.contract.tagOperation not found
