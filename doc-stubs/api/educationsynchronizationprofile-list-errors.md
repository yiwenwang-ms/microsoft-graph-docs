...
-->
``` http
GET /educationRoot/synchronizationProfiles/{educationSynchronizationProfileId}/errors
```
...
-->
``` http
GET https://graph.microsoft.com/beta/educationRoot/synchronizationProfiles/{educationSynchronizationProfileId}/errors
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.Education.DataSync.educationSynchronizationError)"
}
-->
``` http
HTTP/1.1 200 OK
