...
-->
``` http
POST ** Collection URI for Microsoft.Education.DataSync.educationSynchronizationProfileStatus not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for Microsoft.Education.DataSync.educationSynchronizationProfileStatus not found
