...
-->
``` http
GET ** Collection URI for microsoft.strongAuthentication.authentication not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.strongAuthentication.authentication not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.strongAuthentication.authentication)"
}
-->
``` http
HTTP/1.1 200 OK
