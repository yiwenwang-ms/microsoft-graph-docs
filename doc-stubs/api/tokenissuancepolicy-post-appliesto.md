...
-->
``` http
POST /applications/{applicationsId}/tokenIssuancePolicies/{tokenIssuancePolicyId}/appliesTo/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/applications/{applicationsId}/tokenIssuancePolicies/{tokenIssuancePolicyId}/appliesTo/$ref
