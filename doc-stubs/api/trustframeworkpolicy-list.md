...
description: "Get a list of the trustFrameworkPolicy objects and their properties."
...
Get a list of the [trustFrameworkPolicy](../resources/trustframeworkpolicy.md) objects and their properties.
...
<!-- {
  "blockType": "request",
  "name": "list_trustframeworkpolicy"
}
-->
``` http
