...
-->
``` http
GET ** Collection URI for Microsoft.Education.DataSync.educationSynchronizationProfileStatus not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for Microsoft.Education.DataSync.educationSynchronizationProfileStatus not found
```
