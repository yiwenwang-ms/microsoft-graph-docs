...
-->
``` http
GET ** Collection URI for microsoft.strongAuthentication.user not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.strongAuthentication.user not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.strongAuthentication.user)"
}
-->
``` http
HTTP/1.1 200 OK
