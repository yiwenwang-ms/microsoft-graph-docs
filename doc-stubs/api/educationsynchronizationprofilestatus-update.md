...
-->
``` http
PATCH /educationRoot/synchronizationProfiles/{educationSynchronizationProfileId}/profileStatus
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/educationRoot/synchronizationProfiles/{educationSynchronizationProfileId}/profileStatus
