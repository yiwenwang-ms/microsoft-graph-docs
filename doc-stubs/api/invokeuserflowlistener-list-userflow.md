...
description: "Get the b2xIdentityUserFlow resources from the userFlow navigation property."
...
Get the b2xIdentityUserFlow resources from the userFlow navigation property.
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.Cpim.Api.DataModels.b2xIdentityUserFlow)"
}
-->
``` http
HTTP/1.1 200 OK
