...
-->
``` http
POST /policyRoot/activityBasedTimeoutPolicies/{activityBasedTimeoutPolicyId}/appliesTo/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/policyRoot/activityBasedTimeoutPolicies/{activityBasedTimeoutPolicyId}/appliesTo/$ref
