...
Read the properties and relationships of a [userFlowLanguageConfiguration](../resources/userflowlanguageconfiguration.md) object.
...
-->
``` http
GET https://graph.microsoft.com/beta/userFlowLanguageConfiguration
```
