...
The following table shows the properties that are required when you update the [stsPolicy](../resources/stspolicy.md).
...
{
  "@odata.type": "#microsoft.graph.stsPolicy",
  "id": "795c12dd-12dd-795c-dd12-5c79dd125c79",
  "deletedDateTime": "String (timestamp)",
  "description": "String",
  "displayName": "String",
  "definition": [
