---
title: "phoneAuthenticationMethod: resetPassword"
...
# phoneAuthenticationMethod: resetPassword
...
-->
``` http
POST /user/authentication/phoneMethods/{phoneAuthenticationMethodId}/resetPassword
```
...
<!-- {
  "blockType": "request",
  "name": "phoneauthenticationmethod_resetpassword"
}
-->
``` http
POST https://graph.microsoft.com/beta/user/authentication/phoneMethods/{phoneAuthenticationMethodId}/resetPassword
