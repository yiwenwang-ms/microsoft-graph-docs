...
Read the properties and relationships of an [estimateStatisticsOperation](../resources/estimatestatisticsoperation.md) object.
...
If successful, this method returns a `200 OK` response code and an [estimateStatisticsOperation](../resources/estimatestatisticsoperation.md) object in the response body.
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "microsoft.compliance.ediscovery.contract.estimateStatisticsOperation"
}
-->
``` http
HTTP/1.1 200 OK
...

{
  "value": {
    "@odata.type": "#microsoft.compliance.ediscovery.contract.estimateStatisticsOperation",
    "id": "1670aca7-aca7-1670-a7ac-7016a7ac7016",
