...
description: "Get the identityProviderBase resources from the userFlowIdentityProviders navigation property."
...
Get the identityProviderBase resources from the userFlowIdentityProviders navigation property.
...
-->
``` http
GET /identity/b2xUserFlows/{b2xIdentityUserFlowId}/userFlowIdentityProviders
```
...
-->
``` http
GET https://graph.microsoft.com/beta/identity/b2xUserFlows/{b2xIdentityUserFlowId}/userFlowIdentityProviders
```
