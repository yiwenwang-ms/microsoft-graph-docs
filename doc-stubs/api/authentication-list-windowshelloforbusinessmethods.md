---
title: "List windowsHelloForBusinessMethods"
description: "Get the windowsHelloForBusinessAuthenticationMethod resources from the windowsHelloForBusinessMethods navigation property."
...
# List windowsHelloForBusinessMethods
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Get the windowsHelloForBusinessAuthenticationMethod resources from the windowsHelloForBusinessMethods navigation property.
...
-->
``` http
GET /user/authentication/windowsHelloForBusinessMethods
```
...
-->
``` http
GET https://graph.microsoft.com/beta/user/authentication/windowsHelloForBusinessMethods
```
