...
-->
``` http
GET ** Collection URI for Microsoft.Education.DataSync.educationUser not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for Microsoft.Education.DataSync.educationUser not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.Education.DataSync.educationUser)"
}
-->
``` http
HTTP/1.1 200 OK
