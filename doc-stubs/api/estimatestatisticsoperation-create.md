...
-->
``` http
POST ** Collection URI for microsoft.compliance.ediscovery.contract.estimateStatisticsOperation not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.compliance.ediscovery.contract.estimateStatisticsOperation not found
