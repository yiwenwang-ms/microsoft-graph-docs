---
title: "emailAuthenticationMethod: resetPassword"
...
# emailAuthenticationMethod: resetPassword
...
-->
``` http
POST /user/authentication/emailMethods/{emailAuthenticationMethodId}/resetPassword
```
...
<!-- {
  "blockType": "request",
  "name": "emailauthenticationmethod_resetpassword"
}
-->
``` http
POST https://graph.microsoft.com/beta/user/authentication/emailMethods/{emailAuthenticationMethodId}/resetPassword
