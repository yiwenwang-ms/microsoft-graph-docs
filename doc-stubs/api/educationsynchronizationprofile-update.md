...
-->
``` http
PATCH /educationRoot/synchronizationProfiles/{educationSynchronizationProfileId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/educationRoot/synchronizationProfiles/{educationSynchronizationProfileId}
