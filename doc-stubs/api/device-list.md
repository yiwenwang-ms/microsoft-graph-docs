...
-->
``` http
GET ** Collection URI for microsoft.strongAuthentication.device not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.strongAuthentication.device not found
```
