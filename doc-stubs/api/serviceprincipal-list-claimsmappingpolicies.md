...
description: "Get the claimsMappingPolicy resources from the claimsMappingPolicies navigation property."
...
Get the claimsMappingPolicy resources from the claimsMappingPolicies navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/servicePrincipals/{servicePrincipalsId}/claimsMappingPolicies
```
  ...
  "value": [
    {
      ...
      "id": "061ad2aa-d2aa-061a-aad2-1a06aad21a06",
