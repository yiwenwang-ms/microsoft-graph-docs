...
description: "Get the tokenIssuancePolicy resources from the tokenIssuancePolicies navigation property."
...
Get the tokenIssuancePolicy resources from the tokenIssuancePolicies navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/servicePrincipals/{servicePrincipalsId}/tokenIssuancePolicies
```
  ...
  "value": [
    {
      ...
      "id": "dfe9803e-803e-dfe9-3e80-e9df3e80e9df",
