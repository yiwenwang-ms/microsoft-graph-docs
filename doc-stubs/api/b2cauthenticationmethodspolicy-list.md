...
-->
``` http
GET ** Collection URI for Microsoft.Cpim.Api.DataModels.b2cAuthenticationMethodsPolicy not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for Microsoft.Cpim.Api.DataModels.b2cAuthenticationMethodsPolicy not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.Cpim.Api.DataModels.b2cAuthenticationMethodsPolicy)"
}
-->
``` http
HTTP/1.1 200 OK
