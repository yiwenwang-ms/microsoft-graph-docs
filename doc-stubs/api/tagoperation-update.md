...
Update the properties of a [tagOperation](../resources/tagoperation.md) object.
...
The following table shows the properties that are required when you update the [tagOperation](../resources/tagoperation.md).
...
If successful, this method returns a `200 OK` response code and an updated [tagOperation](../resources/tagoperation.md) object in the response body.
