...
-->
``` http
GET ** Collection URI for Microsoft.Cpim.Api.DataModels.authenticationFlowsPolicy not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for Microsoft.Cpim.Api.DataModels.authenticationFlowsPolicy not found
```
