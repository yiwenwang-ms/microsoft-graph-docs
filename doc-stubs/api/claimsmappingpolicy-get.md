...
-->
``` http
GET /policyRoot/claimsMappingPolicies/{claimsMappingPolicyId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/policyRoot/claimsMappingPolicies/{claimsMappingPolicyId}
```
...

{
  "value": {
    "@odata.type": "#Microsoft.DirectoryServices.claimsMappingPolicy",
    "id": "81cb6260-6260-81cb-6062-cb816062cb81",
