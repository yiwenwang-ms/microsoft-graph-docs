...
-->
``` http
POST /servicePrincipals/{servicePrincipalsId}/claimsMappingPolicies/{claimsMappingPolicyId}/appliesTo/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/servicePrincipals/{servicePrincipalsId}/claimsMappingPolicies/{claimsMappingPolicyId}/appliesTo/$ref
