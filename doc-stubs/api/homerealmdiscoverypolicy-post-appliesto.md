...
-->
``` http
POST /applications/{applicationsId}/homeRealmDiscoveryPolicies/{homeRealmDiscoveryPolicyId}/appliesTo/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/applications/{applicationsId}/homeRealmDiscoveryPolicies/{homeRealmDiscoveryPolicyId}/appliesTo/$ref
