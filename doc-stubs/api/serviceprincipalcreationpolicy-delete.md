...
``` http
DELETE /servicePrincipalCreationPolicy
DELETE /policyRoot/servicePrincipalCreationPolicies/{servicePrincipalCreationPolicyId}
```
...
-->
``` http
DELETE https://graph.microsoft.com/beta/servicePrincipalCreationPolicy
```
