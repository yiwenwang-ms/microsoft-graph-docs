...
Read the properties and relationships of an [authenticationListener](../resources/authenticationlistener.md) object.
...
-->
``` http
GET /identity/events/onSignupStart/{authenticationListenerId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/identity/events/onSignupStart/{authenticationListenerId}
```
