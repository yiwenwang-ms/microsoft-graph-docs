...
-->
``` http
POST /user/authentication/passwordMethods/{passwordAuthenticationMethodId}/resetPassword
```
...
-->
``` http
POST https://graph.microsoft.com/beta/user/authentication/passwordMethods/{passwordAuthenticationMethodId}/resetPassword
