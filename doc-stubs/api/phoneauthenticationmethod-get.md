...
-->
``` http
GET /user/authentication/phoneMethods/{phoneAuthenticationMethodId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/user/authentication/phoneMethods/{phoneAuthenticationMethodId}
```
