---
title: "List authenticationListeners"
description: "Get a list of the authenticationListener objects and their properties."
...
# List authenticationListeners
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Get a list of the [authenticationListener](../resources/authenticationlistener.md) objects and their properties.
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.Cpim.Api.DataModels.authenticationListener)"
}
-->
``` http
HTTP/1.1 200 OK
