...
Create a new [userFlowLanguagePage](../resources/userflowlanguagepage.md) object.
...
-->
``` http
POST ** Collection URI for Microsoft.Cpim.Api.DataModels.userFlowLanguagePage not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for Microsoft.Cpim.Api.DataModels.userFlowLanguagePage not found
