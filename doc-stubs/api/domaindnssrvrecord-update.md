...
The following table shows the properties that are required when you update the [domainDnsSrvRecord](../resources/domaindnssrvrecord.md).
...
{
  "@odata.type": "#microsoft.graph.domainDnsSrvRecord",
  "id": "49d2bd01-bd01-49d2-01bd-d24901bdd249",
  "isOptional": "Boolean",
  "label": "String",
  "recordType": "String",
  "supportedService": "String",
