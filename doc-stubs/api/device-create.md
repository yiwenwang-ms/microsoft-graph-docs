...
-->
``` http
POST ** Collection URI for microsoft.strongAuthentication.device not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.strongAuthentication.device not found
