---
title: "List keySets"
description: "Get the trustFrameworkKeySet resources from the keySets navigation property."
...
Get the trustFrameworkKeySet resources from the keySets navigation property.
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.Cpim.Api.DataModels.trustFrameworkKeySet)"
}
-->
``` http
HTTP/1.1 200 OK
