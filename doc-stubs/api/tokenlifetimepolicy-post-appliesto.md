...
-->
``` http
POST /applications/{applicationsId}/tokenLifetimePolicies/{tokenLifetimePolicyId}/appliesTo/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/applications/{applicationsId}/tokenLifetimePolicies/{tokenLifetimePolicyId}/appliesTo/$ref
