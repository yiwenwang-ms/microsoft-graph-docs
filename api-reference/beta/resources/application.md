...
| uniqueName | String | The unique identifier that's assigned to an application when the application is created through Azure Resource Manager. Immutable. Read-only. |
