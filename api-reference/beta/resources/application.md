...
| uniqueName | String | The unique identifier for the application that's assigned to it when it's created through Azure Resource Manager. Immutable. Read-only. |
