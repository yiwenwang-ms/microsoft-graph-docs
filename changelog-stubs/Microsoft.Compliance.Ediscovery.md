...
|:---|:---|:---|
|Addition|beta|Added the **tags** relationship to [case](https://docs.microsoft.com/en-us/graph/api/resources/case?view=graph-rest-beta) resource|
...
|Addition|beta|Added the `applyTags` member to the **caseAction** enumeration|
...
|Deletion|beta|Removed the `tag` member from the **caseAction** enumeration|
